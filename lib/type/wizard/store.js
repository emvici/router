...
Store.prototype.processed = function( stepId ) {
    return this.processedSteps.indexOf( stepId ) !== -1;
};

Store.prototype.process = function ( stepId ) {
    if( this.processedSteps.indexOf( stepId ) !== -1 ) {
        return false;
    }

    this.processedSteps.push( stepId );

    return true;
};

Store.prototype.unprocess = function( stepId ) {
    var i = this.processedSteps.indexOf( stepId );
