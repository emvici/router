    ...
    .then(function () { if( this._shouldSkip() ) return;
        ...
        if( ! this.store.initialized ) {
            ...
            if ( this.router.initialized ) {
                return this.router.initialized.dispatch( req, res );
            }
        }
    ...
    .then(function () { if( this._shouldSkip() ) return;
        ...
        if( req.method == 'POST' ) {
            ...
            .then(function () {
                ...
                var wasSuccessfull = this.process( this.currentStep.name );
                ...
                if( ! nextStep ) {
                    ...
                    debug( 'detecting if step was processed' );
debug('-------');
debug(this.store.processedSteps.indexOf(this.currentStep.name));
debug(nextStep);
debug(this.expectedStep);
debug(this.requestedStep);
debug(this.store.processedSteps.indexOf(this.currentStep.name));
debug(wasSuccessfull+'');
debug('----------------');
                    if( this.requestedStep &&
                        this.currentStep.name === this.requestedStep.name &&
                        !wasSuccessfull ){
                        this.currentStep = this.expectedStep;
                    } else {
                    ...
                    debug( 'redirecting to', this.currentStep.url );
