...
WizardRoute.prototype.dispatch = function () {
    ...
    .then(function () { if( this._shouldSkip() ) return;
        ...
        if( this.req.method === 'POST' ) {
            ...
            .then(function () {
                debug( this.currentStep, this.processError && this.processError.stack );
            });
        }
...
WizardRoute.prototype.complete = function() {
    ...
    return Promise.cast().bind( this )
    .then(function () {
        return options.completed && options.completed.dispatch( this.req, this.res );
    })
    .then(function () {
        this.store.destroy();
    })
