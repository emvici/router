...
Route.construct = function ( options ) {
    ...
    */
    ...
    // PREREQUISITES
    ConstructedRoute.prerequisites = new Stack((function ( prerequisites ) {

        if( Util.isnt.Array( prerequisites ) ) {
            prerequisites = [ prerequisites ];
        }

        var PREREQUISITES = Object.keys(
            TypeRoute.PREREQUISITES ||
            Router.PREREQUISITES
        );

        return Util.Array.each( prerequisites, function ( pr ) {
