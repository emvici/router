        ...
        try {
            while ( i < router.Routes.length ) { i++;
                ...
                .then(function () {
                    ...
                    debug( 'route params: %s', route.params );
                    var stacks = [];
                    ...
                    Util.Array.each( stacks, function ( stack ) {
                        promise = promise.then(function ( value ) {
                            ...
                            return route.prerequisites.dispatch( req, res ).then(function(){
                                debug('prerequisites fullfilled');
